...
def getPaser():
    ...
    parser.add_argument('--num_replays', type=int, default=4, help='# of replays.')
    # trust region
    ...
    while total_step < args.total_steps:
        ...
        while step < args.n_steps:
            ...
            for env_idx in range(args.n_envs):
                ...
                trajectories[env_idx].append([observations[env_idx], actions[env_idx], rewards[env_idx], dones[env_idx], fail, next_observation, means[env_idx], stds[env_idx]])
