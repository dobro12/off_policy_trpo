...
def getPaser():
    ...
    parser.add_argument('--clip_value', type=float, default=0.2, help='PPO\'s clip value.')
    ...
    while total_step < args.total_steps:
        ...
        while step < args.n_steps:
            ...
            for env_idx in range(args.n_envs):
                ...
                agent.add(observations[env_idx], actions[env_idx], rewards[env_idx], dones[env_idx], fail, next_observation, env_idx)
